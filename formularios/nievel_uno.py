...
class NivelUno(Nivel):
    def __init__(self, pantalla:pygame.Surface) -> None:
        ...
        super().__init__(pantalla, fondo, juan, lista_de_plataformas_l1, piso_caida_lv1, lista_de_nieve, lista_de_enemigos_l1, lista_enemgios_caida_l1, lista_de_mejoras_l1, boss_lv1)
